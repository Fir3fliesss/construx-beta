                                  ...
                                  child: Padding(
                                    ...
                                    child: DataTable(
                                      ...
                                      columns: const [
                                        ...
                                        DataColumn(label: Center(child: Text('Warehouse Name'))),
                                        DataColumn(label: Center(child: Text('City'))),
                                        DataColumn(label: Center(child: Text('Address'))),
                                        DataColumn(label: Center(child: Text('Contact Telp'))),
                                        DataColumn(label: Center(child: Text('Email'))),
                                        DataColumn(label: Center(child: Text('Manager'))),
                                        DataColumn(label: Center(child: Text('Creator'))),
                                        DataColumn(label: Center(child: Text('Create Time'))),
                                        DataColumn(label: Center(child: Text('Valid'))),
                                        DataColumn(label: Center(child: Text('Operations'))),
                                      ],
                                      rows: List.generate(
                                        10,
                                        (index) => DataRow(cells: [
