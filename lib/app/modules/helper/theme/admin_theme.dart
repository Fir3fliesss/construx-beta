...
class LeftBarTheme {
  final Color background, backroundDark;
  final Color labelColor;
  final Color activeItemColor, activeItemBackground;

  LeftBarTheme({
    this.background = const Color(0xffffffff),
    this.backroundDark = const Color(0xff313a46),
    this.labelColor = const Color(0xff6c757d),
    this.activeItemColor = const Color(0xff05A67E),
    // this.activeItemColor = const Color(0xff006784),
    this.activeItemBackground = const Color(0xFFD7F1EA),
  ...
  static final LeftBarTheme darkLeftBarTheme = LeftBarTheme(
      ...
      backroundDark: const Color(0xffdcdcdc),
...
class ContentTheme {
  ...
  ContentTheme({
    ...
    this.backroundDark = const Color(0xffF1F1F2),
    this.primary = const Color(0xff2F7FF8),
    // this.primary = const Color(0xff006784),
    this.onPrimary = const Color(0xffffffff),
    this.disabled = const Color(0xffffffff),
    this.onDisabled = const Color(0xffffffff),
    this.secondary = const Color(0xff00B087),
    ...
    this.warning = const Color(0xffF4BF00),
  ...
  static final ContentTheme lightContentTheme = ContentTheme(
    ...
    backroundDark: const Color(0xff313a46),
  ...
  static final ContentTheme darkContentTheme = ContentTheme(
    ...
    backroundDark: const Color(0xffF1F1F2),
    disabled: const Color(0xff444d57),
    onDisabled: const Color(0xff515a65),
