...
import '../modules/delivery_management/bindings/delivery_management_binding.dart';
import '../modules/delivery_management/views/delivery_management_view.dart';
...
import '../modules/inventory_adjust/bindings/inventory_adjust_binding.dart';
import '../modules/inventory_adjust/views/inventory_adjust_view.dart';
import '../modules/inventory_freeze/bindings/inventory_freeze_binding.dart';
import '../modules/inventory_freeze/views/inventory_freeze_view.dart';
...
import '../modules/inventory_take/bindings/inventory_take_binding.dart';
import '../modules/inventory_take/views/inventory_take_view.dart';
...
import '../modules/visual_warehouse/bindings/visual_warehouse_binding.dart';
import '../modules/visual_warehouse/views/visual_warehouse_view.dart';
...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(
        ...
        transition: Transition.noTransition),
    GetPage(
      name: _Paths.INVENTORY_FREEZE,
      page: () => const InventoryFreezeView(),
      binding: InventoryFreezeBinding(),
    ),
    GetPage(
      name: _Paths.INVENTORY_ADJUST,
      page: () => const InventoryAdjustView(),
      binding: InventoryAdjustBinding(),
    ),
    GetPage(
      name: _Paths.INVENTORY_TAKE,
      page: () => const InventoryTakeView(),
      binding: InventoryTakeBinding(),
    ),
    GetPage(
      name: _Paths.DELIVERY_MANAGEMENT,
      page: () => const DeliveryManagementView(),
      binding: DeliveryManagementBinding(),
    ),
    GetPage(
      name: _Paths.VISUAL_WAREHOUSE,
      page: () => const VisualWarehouseView(),
      binding: VisualWarehouseBinding(),
    ),
  ];
}
